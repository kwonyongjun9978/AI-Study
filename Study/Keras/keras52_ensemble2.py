...
x1_train, x1_test, x2_train, x2_test, x3_train, x3_test, y_train, y_test = train_test_split(
    x1_datasets, x2_datasets, x3_datasets, y, train_size=0.7, random_state=444
)
...
model.fit([x1_train, x2_train, x3_train], y_train, epochs=500, batch_size=1)

#4. 평가, 예측
loss = model.evaluate([x1_test, x2_test, x3_test], y_test)
print('loss : ', loss)

#loss :  9.88040542602539