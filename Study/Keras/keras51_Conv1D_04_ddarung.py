...
#2.모델구성
model = Sequential()
model.add(Conv1D(256, 2, input_shape=(9,1), activation='relu'))                                                                                                
...
cnn
loss :  28.234371185302734
RMSE :  41.57138458146762

LSTM
loss :  26.288305282592773
RMSE :  41.828761320681814

Conv1D
loss :  29.43360137939453
RMSE :  46.293002242307644
'''
