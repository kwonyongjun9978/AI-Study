...
x1_train, x1_test, x2_train, x2_test, x3_train, x3_test,\
    ...
    x1_datasets, x2_datasets, x3_datasets, y1, y2, train_size=0.7, random_state=444
)
...
model.fit([x1_train, x2_train, x3_train], [y1_train,y2_train], epochs=10, batch_size=1)
