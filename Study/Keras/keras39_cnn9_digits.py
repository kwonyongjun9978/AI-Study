...
# 2.모델구성
model=Sequential()
model.add(Conv2D(256, (8,1), input_shape=(64,1,1), padding='same',
                 activation='relu'))
model.add(Conv2D(filters=128, kernel_size=(4,1), padding='same'))  
...
ModelCheckpoint = ModelCheckpoint(monitor='val_loss',
                                  ...
                                  verbose=2,
                                  save_best_only=True,
                                  filepath=filepath+'k39_9_'+date+'_'+filename)
