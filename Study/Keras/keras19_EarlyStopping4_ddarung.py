...
earlyStopping = EarlyStopping(monitor='val_loss', 
                              ...
                              verbose=1)
hist=model.fit(x_train, y_train, epochs=10000, batch_size=10, validation_data=(x_validation, y_validation)
...
submission.to_csv(path+'submission_010902.csv')

'''
010901
loss :  31.90024185180664
RMSE :  46.31349165727546
'''

'''
010902
loss :  31.71152114868164
RMSE :  46.938503484307
'''
